...
namespace BTG.Editor
{
    ...
    public class SceneBootstrapper
    {
        ...
        private const string LOAD_BOOTSTRAP_SCENE_ON_PLAY = "Rangers/Load Bootstrap Scene on play";
        private const string DO_NOT_LOAD_BOOTSTRAP_SCENE_ON_PLAY = "Rangers/Do not load Bootstrap Scene on Play";
